...
def cautraloi_cmdfalse():
    ...
    for c in cmd_list:
        if c == "fd":
            turtlelist.forward(cmd_list(cmd_list.index("c") + 1))
        elif c == "bd":
            turtlelist.backward(cmd_list(cmd_list.index("c") + 1))
        elif c == "lt":
            turtlelist.left(cmd_list(cmd_list.index("c") + 1))
        elif c == "rt":
            turtlelist.right(cmd_list(cmd_list.index("c") + 1))
        else:
            cautraloi_cmdfalse()
